...
class MainActivity : AppCompatActivity(), SensorEventListener {
    ...
    private val defaultBtnInfo = mapOf(
        R.id.lay_brake to Pair("BRAKE", R.drawable.ic_brake),
        R.id.lay_gas to Pair("GAS", R.drawable.ic_gas),
        ...
        R.id.lay_gear_up to Pair("R1", R.drawable.ic_gear_up),
        R.id.lay_gear_down to Pair("L1", R.drawable.ic_gear_down)
    )
    ...
    private fun sendReport() {
        try {
            ...
            if (gearDown) b1 = b1 or (1 shl 4) // L1
            if (gearUp)   b1 = b1 or (1 shl 5) // R1

            // D-Pad / WASD for Character Movement
