...
class MainActivity : AppCompatActivity(), SensorEventListener {
    ...
    private fun showModePickerDialog() {
        android.app.AlertDialog.Builder(this)
            .setTitle("Control Mode Chuno")
            .setMessage("Kaunsa layout chahiye?")
            .setCancelable(true)
            .setPositiveButton("🎮 Normal") { _, _ -> switchMode("normal") }
            .setNegativeButton("🏎️ Steering Wheel") { _, _ -> switchMode("wheel") }
            .show()
    }
    ...
    private fun buildView(def: CustomBtn, pb: PlacedCustomBtn,
        ...
        when {
            ...
            def.id == "gas" || def.id == "brake"            -> buildGasBrakeBtn(def, pb, container, inEditMode)
