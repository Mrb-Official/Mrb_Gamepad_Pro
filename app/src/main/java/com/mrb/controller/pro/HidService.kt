    ...
    companion object {
        ...
        val HID_DESC = byteArrayOf(
            ...
            // Axes: X, Y, Z, Rz, Rx, Ry (Total 6 axes)
                        // 🔥 4 Joysticks Axes (Limit -127 to 127) -> Right stick ab gol ghumega
            0x05, 0x01, 
            0x09, 0x30, 0x09, 0x31, // X, Y (Left Stick)
            0x09, 0x32, 0x09, 0x35, // Z, Rz (Right Stick)
            0x15, 0x81.toByte(), 0x25, 0x7f, 0x75, 0x08, 0x95.toByte(), 0x04, 0x81.toByte(), 0x02,

            // 🔥 2 Triggers (Limit 0 to 255) -> Gas aur Brake
            0x05, 0x01,
            0x09, 0x33, 0x09, 0x34, // Rx, Ry (Triggers)
