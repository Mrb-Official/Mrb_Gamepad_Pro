...
class HidService : Service() {
    ...
    companion object {
        ...
        // 🔥 TERA ORIGINAL EXACT 8-BYTE DESCRIPTOR 🔥
        ...
        // [4] Rx axis       (right joystick X / Touchpad X) -127..127
        // [5] Ry axis       (right joystick Y / Touchpad Y) -127..127
        ...
        val HID_DESC = byteArrayOf(
            ...
            // ── Right Joystick X (Rx / Touchpad X) ────────
            0x09, 0x33,             // Usage (Rx)
            0x15, 0x81.toByte(),
            0x25, 0x7f,
            0x75, 0x08,
            ...
            // ── Right Joystick Y (Ry / Touchpad Y) ────────
            0x09, 0x34,             // Usage (Ry)
            0x15, 0x81.toByte(),
            0x25, 0x7f,
            0x75, 0x08,
