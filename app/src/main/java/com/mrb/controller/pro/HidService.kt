...
class HidService : Service() {
    ...
    companion object {
        ...
        // 🔥 NAYA 9-BYTE HYBRID DESCRIPTOR (Mobile + PC/Xbox Dono ke liye) 🔥
            ...
            // ── Left Stick (X, Y) -> Limit -127 to 127 ──
            0x05, 0x01, 
            0x09, 0x30, 0x09, 0x31, 
            0x15, 0x81.toByte(), 0x25, 0x7f, 0x75, 0x08, 0x95.toByte(), 0x02, 0x81.toByte(), 0x02,

            // ── Right Stick (Z, Rz) -> Limit -127 to 127 (Android ab isko pakdega) ──
            0x09, 0x32, 0x09, 0x35, 
            0x15, 0x81.toByte(), 0x25, 0x7f, 0x75, 0x08, 0x95.toByte(), 0x02, 0x81.toByte(), 0x02,

            // ── Triggers L2/R2 (Rx, Ry) -> Limit 0 to 255 (Android aur PC dono ke liye) ──
            0x09, 0x33, 0x09, 0x34, 
