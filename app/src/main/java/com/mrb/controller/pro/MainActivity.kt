...
class MainActivity : AppCompatActivity(), SensorEventListener {
    ...
    private val customButtons = listOf(
        ...
        CustomBtn("btn_x",      "X",        R.drawable.btn_xbox_blue,         0xFF3DB9FF.toInt(), byte1bit = 3),
        CustomBtn("btn_y",      "Y",        R.drawable.btn_xbox_yellow,       0xFFFFD700.toInt(), byte1bit = 4),
        CustomBtn("gas",        "GAS / RT", R.drawable.ic_speed,              0xFF3CFF6B.toInt()),
        CustomBtn("brake",      "BRAKE / LT",R.drawable.ic_hand,              0xFFFF4B4B.toInt()),
        CustomBtn("gear_up",    "REVERSE",  R.drawable.expand_circle_up_24,   0xFFFF6D00.toInt()),
        CustomBtn("gear_down",  "FRONT",    R.drawable.expand_circle_down_24, 0xFF00B4D8.toInt()),
    ...
    private fun sendReport() {
        try {
            ...
            if (customBtnStates["btn_a"] == true) b1 = b1 or (1 shl 0)
            if (customBtnStates["btn_b"] == true) b1 = b1 or (1 shl 1)
            if (customBtnStates["btn_x"] == true) b1 = b1 or (1 shl 3)
            if (customBtnStates["btn_y"] == true) b1 = b1 or (1 shl 4)
            if (customBtnStates["gear_down"] == true) b1 = b1 or (1 shl 2)
            if (customBtnStates["gear_up"]   == true) b1 = b1 or (1 shl 5)

            val excludedFromBits = setOf(
                "btn_a", "btn_b", "btn_x", "btn_y",
                "gear_up", "gear_down", "gas", "brake",
